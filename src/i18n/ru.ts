export const ru = {
  ...
  filters: {
    ...
    sorting: 'Сортировка',
    allGenres: 'Все жанры',
    allCountries: 'Все страны / markets',
    allTypes: 'Все',
    filters: 'Фильтры',
  ...
  about: {
    ...
    intro:
      'Он помогает просматривать свежие релизы Spotify по периоду, жанру, стране или market, типу релиза и популярности. Результаты зависят от выбранных фильтров, а не от личного вкуса, истории прослушиваний или алгоритмического профиля.',
    filtersTitle: 'Что используют фильтры',
    filtersDescription:
      'Дата релиза, тип релиза, жанры артистов, country или market-сигналы и популярность могут приходить из разных полей Spotify metadata. Если поле отсутствует или ненадёжно, Fresh Drop показывает «Неизвестно», а не угадывает.',
