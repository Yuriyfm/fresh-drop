...
Жанры релиза в MVP можно не хранить отдельной таблицей.
...
Если фильтрация по жанрам станет медленной, можно добавить отдельную таблицу или materialized field позже.
