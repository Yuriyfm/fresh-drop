...
* reset filters на десктопе находится в header результатов рядом с sorting, чтобы действие было заметно над выдачей;
...
* рядом с `Open in Spotify` есть компактное действие копирования Spotify-ссылки;
